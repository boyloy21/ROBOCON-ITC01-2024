...
class PID_Simulation(Node):
    def __init__(self):
        ...
        self.Ki = np.array([0.01, 0.01, 0.01])
    ...
    def Calculate_position(self):
        ...
        w1,w2,w3,w4 = self.mec.inverse_kinematic(self.output_vx,self.output_vy,self.output_omega)
        x_next,y_next,yaw_next = self.mec.discrete_state(self.current_x, self.current_y, self.current_yaw,w1,w2,w3,w4,self.sampling_time)
