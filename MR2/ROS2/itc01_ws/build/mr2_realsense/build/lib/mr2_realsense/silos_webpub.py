...
model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/vipho/mr2_ws/src/cv_test/cv_test/last.pt') #last.pt
...
class CameraSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            Image,
           'webcam_image',#'/camera/color/image_raw',
            self.camera_callback,
            10)
        self.subscription

        self.yolov8_pub = self.create_publisher(Yolov8Inference, "/Yolov8_Inference", 30)
        self.img_pub = self.create_publisher(Image, "/image_result", 30)
