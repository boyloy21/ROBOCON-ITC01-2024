...
from utils.dataloaders import VID_FORMATS, LoadStreams, letterbox
...
class Yolov5ROS(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('weights', '/home/cobra/ai_ws/yolov5/runs/train/exp18/weights/best.pt')
        ...
        self.image_subscriber = self.create_subscription(Image, 'video_frames', self.image_callback, 100)
