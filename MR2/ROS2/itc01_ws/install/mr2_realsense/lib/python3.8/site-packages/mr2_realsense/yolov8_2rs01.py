...
class YOLODetector(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('camera', 'both')  # Default to using both cameras
        self.camera_selection = self.get_parameter('camera').get_parameter_value().string_value
    ...
    def initialize_cameras(self):
        # selected_camera = os.getenv('REALSENSE_CAMERA', 'both')

        # if selected_camera in ['both', 'camera1']:
        ...
        # if selected_camera in ['both', 'camera2']:
