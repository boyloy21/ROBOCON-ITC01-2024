...
class CameraSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/jsagx-6/itc01_ws/src/itc01_mr2/mr2_camera/mr2_camera/ball_t03/weights/last.pt')
        # self.model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/vipho/mr2_ws/src/cv_test/cv_test/best_18.pt')
        
        self.yolov8_inference = Yolov8Inference()

        self.subscription = self.create_subscription(
            Image,
            '/camera/color/image_raw',#'webcam_image',#'/camera/color/image_raw',
