...
# model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/vipho/mr2_ws/src/cv_test/cv_test/ball_train/last.pt') #last.pt
model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/jsagx-6/itc01_ws/src/itc01_mr2/cv_test/cv_test/ball_t03/weights/last.pt') #last.pt
