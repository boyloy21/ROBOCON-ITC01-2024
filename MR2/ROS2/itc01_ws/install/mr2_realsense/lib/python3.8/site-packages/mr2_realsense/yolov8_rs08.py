...
class YOLODetector(Node):
    ...
    def __init__(self):
        ...
        # self.config.enable_device('230122070111') #cam1(behide)
        # self.config.enable_device('239722073716') #cam2(front)
    ...
    def detect_objects(self):
        ...
        results = self.model(color_image, conf = 0.52)
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                if int(c) == 2:
                    # ball_class = "blue ball" if class_name == "blue" else ("red ball" if class_name == "red" else "purple ball")
