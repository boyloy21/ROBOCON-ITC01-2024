            ...
            try:
                ...
                if(can_msg != None):            
                    if can_msg.arbitration_id == 0x407:
                        ...
                        laserx = can_msg.data[6]
                        lasery = can_msg.data[7]
                        self.W1=float(map(self.V1_back,0,65535,-100,100))
                        self.W2=float(map(self.V2_back,0,65535,-100,100))
                        self.Omega_back = float(map(self.Omega_back,0,65535,-3.14159,3.14159))
                        self.LaserX = float(map(laserx, 0, 255, 0.0, 10.0))
                        self.LaserY = float(map(lasery, 0, 255, 0.0, 10.0))
                        ...
                        if (self.Omega_back < 0.001 and self.Omega_back > - 0.001):
                            self.Omega_back = 0.0
                        external.data = [self.W1, self.W2, self.Omega_back]
                        laser.data = [self.LaserX, self.LaserY]
                        self.external_pub.publish(external)
